	...
	fflush(stdout);
		...
		void brave(){	
			...
			void ferrari(){	
				tag = 14;
				int passby;
				printf("\n%s : I have always wanted to drive one of these supercars but dad always stopped me.. Now's my chance!!",name);
				getchar();
				printf("\n...inside the car.....");
				getchar();
				...
				getchar();
				printf("\n%s : Wait... Wha- How- I- It doesn't make any se- UGH. I've so many questions to ask, but let's go get my dad first !",name);
				getchar();
				printf("\n...10 minutes later...\n");
				getchar();
