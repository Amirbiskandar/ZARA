...
void riddle();
void savemum();
void box(int x, int y, int offset);
int selector(int offsetx, int opts,int offsety);
...
//global declarations
char name[1000], ch='0';
int prog, lives, deathcount,trex, tag, daddy=0, time=50;//trex is dummy variable for step by step choice
...
getchar();*/
	...
	int count;
	printf("Use arrow keys. Followed by enter. (Press Alt+F4 to exit at any time)");
	setcursor(0,7);
	printf("[ ] : New Game \n[ ] : Load Game \n[ ] : Credits\n[ ] : Help\n[ ] : Settings\n");
	menu = selector(1,5,7);
	system("cls");
	switch(menu)
		{
			...
			case 3:
				...
				break;
			case 4:
				printf("1. Use arrow keys to choose an option");
				getchar();
			...
			case 5:
				...
				setcursor(0,3);//(x,y)
				printf("[ ] Yes\n[ ] No");
				i = selector(1,2,3);//(number of options,y)
				system("cls");
				fflush(stdout);
				}
...
void box(int x, int y, int offset){
		setcursor(x,y+offset-2);
		printf(" ");
		setcursor(x,y+offset-1);
		printf("%c",254);
		setcursor(x,y+offset);
		printf(" ");
		setcursor(x,y+offset-1);
}
...
void credits(){
	...
	setcursor(0,3);//(x,y)
	printf("[ ] Amir Bin Iskandar\t\t\t2017645628\n[ ] Muhammad Wafiq Bin Ahmad Anuar\t2017671406\n[ ] Muhammad Fauzan Bin Mohd Isa\t2017658474\n[ ] Return to Main Menu");
	trex = selector(1,4,3);//(number of options,y-1)
	switch(trex){
		case 1 :
			system("cls");
			printf("Amir Bin Iskandar\niskandar.amir@gmail.com\n\n- Head Programmer\n- Editor\n- Designer");
		...
		case 2 :
			system("cls");
			printf("Muhammad Wafiq Bin Ahmad Anuar\nwafiq99@gmail.com\n\n- Programmer\n- Writer");
			printf("\nPress enter to return");
			getchar();
			credits();
			break;
		...
		case 3 :
			system("cls");
			printf("Muhammad Fauzan Bin Mohd Isa\nfauzanohyeah99@gmail.com\n\n- Programmer\n- Writer");
			printf("\nPress enter to return");
			getchar();
			credits();
			break;
...
void introduction(){
	...
	trex = selector(1,2,3);//(number of options,y-1)
	int i;
	if(trex==1||trex==2)
	for(i=0;i<time/2;i++){
...
printf(":----:---..---::::-......::::/:::::-...-.---.............------::::::::::::::::::::::::---....```.``.-...--.--....-...-::-..-....-:::-:::---:--.````.`\n");
	...
	trex = selector(1,2,53);//(number of options,y)
	system("cls");
	fflush(stdout);
	...
	getchar();
	printf("...%s was one of 10,000 innocent people perished from the first event of the apocalypse...\n",name);
	tag=11;
	getchar();
	fflush(stdout);
	getchar();
	...
	void curious(){	
		int i;
		system("cls");
		printf("\n%s : But - but I bought this computer 10 years ago... And only now you appear? Why should I believe you?",name);
		getchar();
		...
		getchar();
		printf("\nZara : That was just the beginning.");
		getchar();
		printf("\nZara : Suspected death toll is approximately 10,000 people");
		getchar();
		printf("\n%s : What?I am confused now ... How did you know all this ? I've got to phone my parents and check on them.",name);
		getchar();
		system("cls");
		...
		printf("\n...call denied...\n");
		getchar();
		printf("\nZara :  The event seems to have totally destroyed the line around this area. Luckily I work on satelite.");
		getchar();
		printf("\n%s : But I've got to make sure they're safe. I've got to somehow make sure they know that I survived. Wait. Are they fine Zara?",name);
		getchar();
		...
		getchar();
		printf("\nZara :  %s, I suggest we go out there and save your parents. I will be guiding you all the way!",name);
		getchar();
		system("cls");
		printf("\nZara :  %s, I suggest we go out there and save your parents. I will be guiding you all the way!",name);
		setcursor(0,4);
...
getchar();
	fflush(stdout);
			...
			getchar();
			printf("%s : I am fine thanks. Besides, my parents told me not to leave this house for the whole day today so...\n",name);
			getchar();
		...
		void brave(){	
			...
			void ferrari(){	
				tag = 14;
				int passby;
				printf("\n%s : I have always wanted to drive one of these supercars but dad always stopped me.. Now is my chance!!",name);
				getchar();
				printf("\n...inside the car.....");
				getchar();
				printf("\nZara : Great choice of car. Mind you there is not much fuel left...");
				getchar();
				printf("\n%s : Don't worry I know a petrol station nearby. Let us get going! Are we saving mum or dad first??\n",name);
				getchar();
				...
				getchar();
				printf("\n%s : So let us go and save my dad first then!",name);
				getchar();
				...
				getchar();
				printf("\n%s : Wait... Wha- How- I- It doesn't make any se- UGH. I've so many questions to ask, but let us go get my dad first !",name);
				getchar();
				printf("\n...10 minutes later...\n");
				getchar();
				printf("\n%s : We've arrived at the petrol station. I'll go get the pump and we should be off soon!",name);
				getchar();
				printf("\n%s : Don't tell dad, but I've took his credit card hehe. It is kind of a dire need now right?\n",name);
				getchar();
				cardpin(&passby);
				if(passby==1){
					//pin success
	...
	getchar();
			...
			void cardpin(int *y){	
				...
				if (i==4)
				{
				printf("\n%s : I can not do this Zara ... It is not going to work , it is impossible ...",name);
				printf("\nZara : Watch out ! There is somebody behind you !");
				...
				*y=1;
				...
				void move(){	
					...
					if(trex==1){
						...
						printf("\n%s : Oh no .. We can’t get out from here either since there is no way to make a u turn . I have to run now !",name);
	...
	getchar();
					...
					void longcut(){	
						...
						getchar();
						printf("\n%s : look there is an old lady walking cluelessly ! Should I stop by and help her out ?",name);
	...
	getchar();
						...
						void ignoreold(){	
							...
							getchar();
							printf("\nZara : I am relying on satellites to gether information. It is slower than 4G.");
							...
							printf("\nMs. Pamela : Yes, he is currently in a meeting with the Head of the company up at the 7th floor.");
							...
							printf("\n%s : I know but, but he is in a meeting right now and I can't just barge in, right ?",name);
							printf("\n%s : Let us get to the 7th floor first eh.",name);
	...
	getchar();
								...
								printf("\n%s : Zara, It is fine . This building is strong !",name);
							...
							void barge(){	
								...
								printf("\nDad : What are you doing here %s? Let us talk this outside will you ?I am sorry everyone to cause such a chaos in this meeting",name);
								getchar();
								printf("\n...Outside the meeting room...");
								getchar();
								printf("\nDad : WHAT IN THE WORLD DO YOU THINK YOU ARE DOING?!");
								printf("\n%s : Dad, it is an urgent matter ,please believe me !",name);
								...
								if(trex==1){
									printf("\n%s : Dad, it is fine . You can trust her .Trust me ",name);
									printf("\nDad : If anything is to happen to your mother, I won't forgive you!");
									printf("\n%s : Dad. I promise . Everything will be fine . Let us get you a car and Zara will help you ",name);
									getchar();
	...
	fflush(stdout);
									...
									printf("\n%s : Zara, I think it is fine with dad following us . Besides, I am scared if anything were to happen to him.",name);
									printf("\nZara : So be it");
									...
									printf("\n%s : It is okay dad. Let us get her together",name);
	...
	if(trex==1){
		...
		void bus(){	
			...
			if(trex==1){
				...
				getchar();
				printf("\n%s : Heheheheh..Oh sorry now let us stop at this station and we figure out other ways to go to mom's office",name);
				getchar();
				printf("\nZara : Right.");
				getchar();
			...
			void oldman(){	
				...
				getchar();
				printf("\nOld Man:That is a drugs my child.. Now give it to me before you get caught because of it");
				getchar();
		...
		void uber(){	
			...
			void talk(){	
				...
				void treat(){	
					...
					getchar();
					printf("\nDoctor : Don't be afraid my kid. Your arm is not broken, your arm just dislocate and I am glad that you tend to treat it fast");
					getchar();
					...
					getchar();
					printf("\nDoctor : Why are you talking at your phone kid?");
					getchar();
			...
			void silence(){	
				system("cls");
				printf("\nYou choose to remain silent inside the Uber car");
				printf("\nAfter a few minutes, you arrive at your mom's office and you pay your Uber driver");
				getchar();
				fflush(stdout);
				riddle();
			}
				...
				void riddle(){
					...
					void savemum(){	
						...
						if(trex==1){
							...
							getchar();
							printf("\nYour father answers the call and explains everything to your mother");
							...
							quiz();
						}else if(trex==2 && daddy!=1){//not dad
							system("cls");
							printf("%s : Mom!! Wait!! I found and help papa just now",name);
							getchar();
							printf("Mom : Papa? Are you sure?");
							getchar();
							printf("%s : Yes mom..You can call papa and he will tell you everything",name);
							getchar();
							printf("Mom : Okay I will call him but don't lie to me my dear %s",name);
							getchar();
							printf("%s : I am not lying mom.. please call papa now..",name);
							getchar();
							printf("Your mother start dialing your father mobile number and calls him");
							getchar();
							printf("%s : Please answer the call papa",name);
							getchar();
							printf("Your father answers the call and explains everything to your mother");
							getchar();
							...
							for(i=0;i<time;i++){
								...
								printf("\nYour mother start dialing your father mobile number and calls him");
								printf("\n%s : Please answer the call papa",name);
								printf("\n    Zara    answers the call and explains everything to your mother");								
							}
							
							printf("\nYour mother look really shocked as she hangs up the phone");
							getchar();
							printf("\nMom : Okay I trust you this time. Now show me the way to the safe place");
							getchar();
							printf("%s : Finally!! Okay mom let's goo",name);
							...
							getchar();
							printf("\n%s : Sir there will be earthquakes, tornadoes, tsunamis and many more coming..",name);
							getchar();
							printf("\n%s : I need to save my mom quickly sir before it is too late",name);
							getchar();
							...
							printf("\nthe traffic light is not working and there is no police controlling the busy traffic");
							getchar();
							...
							getchar();
							printf("\nBOOOMMMMM..Your car explodes and you died with the guard");
							die();
						}else{
							printf("Invalid choice. Try again.");
							savemum();
...
//			printf("%d\n",guess[r]);
		...
		if(right==3)
		break;
		if(guess[1]==guess[2] || guess[1]==guess[3] || guess[2]==guess[3])
			printf("Caveman : YOU FOOL! I SAID NO REPEATED NUMBAHHHS\n");
		else if(right==-99){
			printf("Caveman : YOU FOOL! I SAID NUMBAHHHS\n");
		}else
...
printf("\nThere was a furious thunderous roar, and the shockwave from the earthquake and the tsunami could be felt throughout the cave");
getchar();
printf("\nas the world continue to self - destruct... Suddenly , a bald man with a cape stood up amongst the survivors.");
getchar();
printf("\n""YOU ARE ALL SURVIVORS OF THE WORLD !""");
getchar();
printf("\n""STARTING TOMORROW, ALL OF YOU WILL START A NEW CIVILISATION ! A BETTER ONE!!!""");
getchar();
